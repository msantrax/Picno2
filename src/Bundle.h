...
const struct bundle{
    ...
    const char * msg;
          ...
          {102, 0, 0, 0,     "",                       "Ajustar data/hora",                    "" },
            ...
            {0, 1, 0, 0,     "logonstart",             "Autenticar apos reset",                "Questionar usuario\nsobre senha\napos o reset ?" },
//13
            {0, 1, 1, 0,     "sample_weight",          "Massa Padrao",                         "Defina\nMassa" },
            
            {0, 1, 1, 2,     "sphere_vol_g",           "Volume da Esfera [G]",                 "Volume da\nEsfera [G]" },
            {0, 1, 1, 2,     "sphere_vol_m",           "Volume da Esfera [M]",                 "Volume da\nEsfera [M]" },
            {0, 1, 1, 2,     "sphere_vol_p",           "Volume da Esfera [P]",                 "Volume da\nEsfera [P]" },
...
//            {0, 1, 1, 0,     "sphere_volume",          "Volume da Esfera",                     "Volume da\nEsfera" },
//            
//17-30            
